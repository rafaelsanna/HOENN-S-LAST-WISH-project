...
# HOENN'S LAST WISH - HGSS-only wallpaper standardization V20b
#
# Goal:
...
BACKUP="$ROOT/.hlw_hgss_only_v20b_backup_$STAMP"
...
# copied/used by the player-facing V20b menu.
mapfile -t HGSS_DIRS < <(
    find "$UPSTREAM_ASSETS" -mindepth 2 -maxdepth 2 -type f -name 'tiles.png' -printf '%h\n' \
...
Path(output_path).write_text(
    "// HLW V20b: standardized HGSS wallpaper data; legacy regular IDs are hidden.\n" +
