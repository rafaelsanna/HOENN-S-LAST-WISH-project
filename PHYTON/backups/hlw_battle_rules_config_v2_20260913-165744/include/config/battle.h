...
#define B_SMART_WILD_AI_FLAG        0x27C     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define B_FLAG_NO_BAG_USE           0x44     // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          0x1E3     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           0x1AB      // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define B_FLAG_NO_WHITEOUT          0xE9      // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
...
#define B_FAST_INTRO_NO_SLIDE               0x1DA  // If set to TRUE, the slide animation that happens at the beginning of the battle is skipped.
...
#define B_SHOW_TYPES        SHOW_TYPES_ALWAYS     // HLW_SHOW_TYPES_OPTION_V1: compiled in; runtime visibility uses FLAG_HIDE_BATTLE_TYPES.
