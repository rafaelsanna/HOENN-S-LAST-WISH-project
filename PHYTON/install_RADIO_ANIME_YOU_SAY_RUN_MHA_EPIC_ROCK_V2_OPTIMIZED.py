...
PACK_ZIP="RADIO_ANIME_YOU_SAY_RUN_MHA_EPIC_ROCK_V2_OPTIMIZED.zip"
MIDI_SHA256="b09937e9a7536da9b731cc21c57a8a07d4f767f01eccd2156c38c91925a92f54"
...
def main():
    ...
    bdir=root/"PHYTON/backups"/f"you_say_run_v2_optimized_{stamp}"
    ...
    print("\nV2 OPTIMIZED instalada:")
    print("  - guitarra HIGH da V1 descartada")
    print("  - guitarra LOW distortion escolhida")
    print("  - violin = exatamente o voice de Brothers")
    print("  - saw/vibraphone/choir digital agora vao para piano")
    print("  - violin toca apenas as linhas reais de violin")
