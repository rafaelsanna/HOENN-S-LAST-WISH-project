...
PACK_ZIP="RADIO_ANIME_YOU_SAY_RUN_MHA_EPIC_ROCK_V4_REAL_DRUMS.zip"
MIDI_SHA256="8d3f192ade9be05ea8672e7c970967e8f5bd2e35e03304603ea8592415eb1d9f"
...
def main():
    ...
    bdir=root/"PHYTON/backups"/f"you_say_run_v4_real_drums_{stamp}"
    ...
    print("\nV4 REAL ROCK DRUMS instalada:")
    print("  - guitarra V3 preservada EXATAMENTE")
    print("  - bateria digital/original foi REMOVIDA")
    print("  - violin = exatamente o voice de Brothers")
    print("  - bateria agora usa groove ROCK simples 36/40/42")
    print("  - depois da intro: hats em SEMINIMAS, kick 1/3, snare 2/4")
    print("  - no riff: hats em colcheias, sem machine-gun / 909")
    print("  - piano/guitarra/violin da V3 ficaram intactos")
