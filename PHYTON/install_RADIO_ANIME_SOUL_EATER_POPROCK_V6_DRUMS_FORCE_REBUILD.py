...
PACK_ZIP = "RADIO_ANIME_SOUL_EATER_POPROCK_V6_DRUMS.zip"
EXPECTED_HASHES = {'assets/mus_resonance.mid': 'd74101fdff49424afb0979bb584ccf8a6bbce13d6c5d9089ee8fef61768f5609', 'assets/mus_paper_moon.mid': 'cfb0481e112322c22cab52f79dbf86170e7177cc6bb0f52cb5ad3afa4cb6ff28'}
...
def main():
    ...
    print("== SOUL EATER POP-ROCK V6 / DRUMS ==")
    ...
    bdir = root/"PHYTON/backups"/f"soul_eater_poprock_v6_drums_{stamp}"
    ...
    print("  - bateria V6 adicionada usando SOMENTE 36 kick / 40 snare / 42 hat")
    print("  - Resonance: groove dance-rock; Paper Moon: groove pop-rock/pop-punk")
    print("  - demais instrumentos/arranjo da V5 preservados")
    print("\nAgora: make -j8")
