...
PACK_ZIP="RADIO_ANIME_YOU_SAY_RUN_MHA_EPIC_ROCK_V3_RIFF_ONLY_GUITAR.zip"
MIDI_SHA256="b67bce8e6e1f170f069be31bbac85ea0f770db6533240ca9472a9d0a25e54e81"
...
def main():
    ...
    bdir=root/"PHYTON/backups"/f"you_say_run_v3_riff_only_{stamp}"
    ...
    print("\nV3 RIFF-ONLY GUITAR instalada:")
    print("  - existe apenas UMA guitarra no arranjo")
    print("  - guitarra so entra no trecho de RIFF (tick 49152 / ~42.7s)")
    print("  - violin = exatamente o voice de Brothers")
    print("  - harmonia de guitarra antes do riff foi transferida para PIANO")
    print("  - saw/vibraphone/choir digital continuam no piano; violin so linhas reais")
    print("  - piano limitado a 3 notas por ataque")
    print("  - volumes reduzidos para tirar estourado")
