...
#ifndef VAR_FLIP_WINNINGS
#define VAR_FLIP_WINNINGS VAR_TEMP_4
#endif
#ifndef VAR_FLAPPY_HISCORE
#define VAR_FLAPPY_HISCORE VAR_TEMP_5
#endif
...
static u8 *sFlappyDecompressionBuffer = NULL;
...
{
    sFlappyDecompressionBuffer = AllocZeroed(0x4000);
	u8 taskId = 0;
...
static void CreateCreditSprites(void)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sSpriteSheets_CreditsInterface) - 1; i++)  
    {
        ...
        LZ77UnCompWram(sSpriteSheets_CreditsInterface[i].data, sFlappyDecompressionBuffer);
        s.data = sFlappyDecompressionBuffer;
...
static void CreateScore(void)
{
	struct SpriteSheet s;
        ...
        LZ77UnCompWram(sSpriteSheet_Score.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateScore2(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Score2.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateFlap(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Flap.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateOne(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_One.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateTwo(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Two.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateThree(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Three.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateStart(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Start.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateHiScore(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_HiScore.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateGameOver(void)
{
	struct SpriteSheet s;
		...
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_GameOver.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
{
	struct SpriteSheet s;
        LZ77UnCompWram(sSpriteSheet_Butterfree_Hitbox.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
{
	struct SpriteSheet s;
        LZ77UnCompWram(sSpriteSheet_Border.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
{
	struct SpriteSheet s;
        LZ77UnCompWram(sSpriteSheet_Border_2.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
{
	struct SpriteSheet s;
        LZ77UnCompWram(sSpriteSheet_Butterfree.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void CreateDamage(void)
{
	struct SpriteSheet s;
		LoadSpritePalettes(sSpritePalettes);
        LZ77UnCompWram(sSpriteSheet_Damage.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
{
	struct SpriteSheet s;
        LZ77UnCompWram(sSpriteSheet_Trail.data, sFlappyDecompressionBuffer);
		s.data = sFlappyDecompressionBuffer;
...
static void FlappyBirdMain(u8 taskId)
{
	...
	switch (sFlappy->state)
	{
		case FLAPPY_INIT:
			...
			{
				PlayCry_Normal(SPECIES_JIRACHI, 0);
                PlayCry_Normal(SPECIES_CELEBI, 0);
				gSprites[sFlappy->ButterfreeSpriteId].animNum = 1;
				sFlappy->timerDelay--;
			}
