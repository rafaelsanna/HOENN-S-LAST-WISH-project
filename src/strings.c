...
const u8 gText_ExpandedPlaceholder_Archie[] = _("INAE");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("MAGNUS");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("KYOGRE");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("GROUDON");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("ZENNO");
const u8 gText_ExpandedPlaceholder_May[] = _("ZINNIA");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. ACACIA's POKéDEX rating!\pPROF. ACACIA: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. ACACIA is in trouble!\nRelease a POKéMON and help her!");
...
const u8 gText_EggFromPetalburgCity[] = _("A POKéMON EGG obtained\nin PETALBURG CITY.");
...
const u8 gText_Wallace[] = _("STELLA");
const u8 gText_Steven[] = _("STELLA");
const u8 gText_Brawly[] = _("RENTON");
const u8 gText_Winona[] = _("TAKA");
...
const u8 gText_OptionMenuSave[] = _("SAVE AND EXIT");
...
const u8 gText_MenuPlayer[] = _("PROFILE"); // {PLAYER}
...
const u8 gText_YouDontHaveEnoughCoins[] = _("You don't have enough COINS.");
const u8 gText_SlotBetHelp[] = _("Bets: 1, 2, or 3 COINS");
const u8 gText_SlotBetHelpHighStakes[] = _("Bets: 10, 20, or 30 COINS");
