...
static const u8 sDoorAnimPalettes_FallarborLightRoof[] = {6, 6, 5, 5, 5, 5, 5, 5};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_hlwcustom1_Cafe_Door,                         &gTileset_HlwCustom1, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_CafeDoor, sDoorAnimPalettes_CafeDoor},
#else
