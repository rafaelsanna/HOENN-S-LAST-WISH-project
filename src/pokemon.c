...
{
    HOENN_TO_NATIONAL(BULBASAUR),    // Posição 0 do array = Hoenn Dex #1
    HOENN_TO_NATIONAL(IVYSAUR),      // Posição 1 do array = Hoenn Dex #2
    HOENN_TO_NATIONAL(VENUSAUR),     // Posição 2 do array = Hoenn Dex #3
    HOENN_TO_NATIONAL(TOTODILE),     // Posição 3 do array = Hoenn Dex #4
    HOENN_TO_NATIONAL(CROCONAW),     // etc...
