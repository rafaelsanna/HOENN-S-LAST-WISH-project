...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_PHOENIX_TOWN] = {MAP_GROUP(MAP_PHOENIX_TOWN), MAP_NUM(MAP_PHOENIX_TOWN), HEAL_LOCATION_PHOENIX_TOWN},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_PHOENIX_TOWN:
        return FlagGet(FLAG_VISITED_PHOENIX_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
