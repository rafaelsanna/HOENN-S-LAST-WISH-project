...
static u16 Debug_CountMapItems(void);
static const u8 *Debug_GetVisibleItemName(u16 flagId);
static void DebugTask_HandleEncounterInfo(u8 taskId);
static u8 Debug_DrawEncounterInfoPage(u8 windowId, u8 page, u8 offset);
static void DebugAction_Util_LastHealPoint(u8 taskId);
static void DebugAction_Util_SetMonLevelCap(u8 taskId);
static void DebugTask_HandleSetMonLevelCap(u8 taskId);
static void Debug_DrawSetMonLevelCap(u8 windowId, s8 slot);
...
static void DebugAction_ShowDestructiveConfirmation(u8 taskId, u8 target);
static void DebugTask_HandleDestructiveConfirmation(u8 taskId);
...
static const u8 sDebugText_EncounterNoData[] = _("No encounter data for this map.");
static const u8 sDebugText_EncounterEmpty[] = _("No encounters in this category.");
static const u8 sDebugText_EncounterLand[] = _("LAND");
static const u8 sDebugText_EncounterWater[] = _("WATER");
static const u8 sDebugText_EncounterRocks[] = _("ROCK/HEADBUTT");
static const u8 sDebugText_EncounterOldRod[] = _("OLD ROD");
static const u8 sDebugText_EncounterGoodRod[] = _("GOOD ROD");
static const u8 sDebugText_EncounterSuperRod[] = _("SUPER ROD");
static const u8 sDebugText_EncounterControls[] = _("L/R Page U/D List B Back");
static const u8 sDebugText_EncounterLevel[] = _("Lv.");

static const u8 sDebugText_InfoItemsTitle[] = _("ITEM INFO");
static const u8 sDebugText_InfoItemsControls[] = _("U/D List   B Back");
static const u8 sDebugText_InfoItemsNone[] = _("No map items.");
static const u8 sDebugText_InfoItemsAvailable[] = _("AVAILABLE");
static const u8 sDebugText_InfoItemsCollected[] = _("COLLECTED");

static const u8 sDebugText_SetMonCapTitle[] = _("Set Mon to Level Cap");
static const u8 sDebugText_SetMonCapControls[] = _("L/R Choose   A Set   B Back");
static const u8 sDebugText_SetMonCapNoMon[] = _("No usable party Pokémon.");

struct DebugVisibleItemFlagName
{
    u16 flagId;
    const u8 *name;
};

static const struct DebugVisibleItemFlagName sDebugVisibleItemFlagNames[] =
{
    { FLAG_ITEM_ROUTE_102_POTION, COMPOUND_STRING("Potion") },
    { FLAG_ITEM_ROUTE_116_METAL_COAT, COMPOUND_STRING("Metal Coat") },
    { FLAG_ITEM_ROUTE_104_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_ROUTE_105_IRON, COMPOUND_STRING("Iron") },
    { FLAG_ITEM_ROUTE_106_PROTEIN, COMPOUND_STRING("Protein") },
    { FLAG_ITEM_ROUTE_109_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_ROUTE_110_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_110_DIRE_HIT, COMPOUND_STRING("Dire Hit") },
    { FLAG_ITEM_ROUTE_111_TM_SANDSTORM, COMPOUND_STRING("TM Sandstorm") },
    { FLAG_ITEM_ROUTE_111_STARDUST, COMPOUND_STRING("Stardust") },
    { FLAG_ITEM_ROUTE_111_HP_UP, COMPOUND_STRING("Hp Up") },
    { FLAG_ITEM_ROUTE_112_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_ROUTE_113_MAX_ETHER, COMPOUND_STRING("Max Ether") },
    { FLAG_ITEM_ROUTE_113_SUPER_REPEL, COMPOUND_STRING("Super Repel") },
    { FLAG_ITEM_ROUTE_114_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_114_PROTEIN, COMPOUND_STRING("Protein") },
    { FLAG_ITEM_ROUTE_115_SUPER_POTION, COMPOUND_STRING("Super Potion") },
    { FLAG_ITEM_ROUTE_115_TM_FOCUS_PUNCH, COMPOUND_STRING("TM Focus Punch") },
    { FLAG_ITEM_ROUTE_115_IRON, COMPOUND_STRING("Iron") },
    { FLAG_ITEM_ROUTE_116_ETHER, COMPOUND_STRING("Ether") },
    { FLAG_ITEM_ROUTE_116_REPEL, COMPOUND_STRING("Repel") },
    { FLAG_ITEM_ROUTE_116_HP_UP, COMPOUND_STRING("Hp Up") },
    { FLAG_ITEM_ROUTE_117_GREAT_BALL, COMPOUND_STRING("Great Ball") },
    { FLAG_ITEM_ROUTE_117_REVIVE, COMPOUND_STRING("Revive") },
    { FLAG_ITEM_ROUTE_119_SUPER_REPEL, COMPOUND_STRING("Super Repel") },
    { FLAG_ITEM_ROUTE_119_ZINC, COMPOUND_STRING("Zinc") },
    { FLAG_ITEM_ROUTE_119_ELIXIR_1, COMPOUND_STRING("Elixir") },
    { FLAG_ITEM_ROUTE_119_LEAF_STONE, COMPOUND_STRING("Leaf Stone") },
    { FLAG_ITEM_ROUTE_119_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_119_HYPER_POTION_1, COMPOUND_STRING("Hyper Potion") },
    { FLAG_ITEM_ROUTE_120_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_ROUTE_120_FULL_HEAL, COMPOUND_STRING("Full Heal") },
    { FLAG_ITEM_ROUTE_123_CALCIUM, COMPOUND_STRING("Calcium") },
    { FLAG_ITEM_ROUTE_123_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_127_ZINC, COMPOUND_STRING("Zinc") },
    { FLAG_ITEM_ROUTE_127_CARBOS, COMPOUND_STRING("Carbos") },
    { FLAG_ITEM_ROUTE_132_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_133_BIG_PEARL, COMPOUND_STRING("Big Pearl") },
    { FLAG_ITEM_ROUTE_133_STAR_PIECE, COMPOUND_STRING("Star Piece") },
    { FLAG_ITEM_PETALBURG_CITY_MAX_REVIVE, COMPOUND_STRING("Max Revive") },
    { FLAG_ITEM_PETALBURG_CITY_ETHER, COMPOUND_STRING("Ether") },
    { FLAG_ITEM_RUSTBORO_CITY_TINY_MUSHROOM, COMPOUND_STRING("Tiny Mushroom") },
    { FLAG_ITEM_LILYCOVE_CITY_MAX_REPEL, COMPOUND_STRING("Max Repel") },
    { FLAG_ITEM_MOSSDEEP_CITY_NET_BALL, COMPOUND_STRING("Net Ball") },
    { FLAG_ITEM_METEOR_FALLS_1F_1R_TM_IRON_TAIL, COMPOUND_STRING("TM Iron Tail") },
    { FLAG_ITEM_METEOR_FALLS_1F_1R_FULL_HEAL, COMPOUND_STRING("Full Heal") },
    { FLAG_ITEM_METEOR_FALLS_1F_1R_MOON_STONE, COMPOUND_STRING("Moon Stone") },
    { FLAG_ITEM_METEOR_FALLS_1F_1R_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_RUSTURF_TUNNEL_POKE_BALL, COMPOUND_STRING("Poke Ball") },
    { FLAG_ITEM_RUSTURF_TUNNEL_MAX_ETHER, COMPOUND_STRING("Max Ether") },
    { FLAG_ITEM_GRANITE_CAVE_1F_ESCAPE_ROPE, COMPOUND_STRING("Escape Rope") },
    { FLAG_ITEM_GRANITE_CAVE_B1F_DUSK_BALL, COMPOUND_STRING("Dusk Ball") },
    { FLAG_ITEM_MT_PYRE_5F_LAX_INCENSE, COMPOUND_STRING("Lax Incense") },
    { FLAG_ITEM_GRANITE_CAVE_B2F_REPEL, COMPOUND_STRING("Repel") },
    { FLAG_ITEM_GRANITE_CAVE_B2F_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_PETALBURG_WOODS_LEAF_STONE, COMPOUND_STRING("Leaf Stone") },
    { FLAG_ITEM_PETALBURG_WOODS_SILVER_POWDER, COMPOUND_STRING("Silver Powder") },
    { FLAG_ITEM_ROUTE_104_POKE_BALL, COMPOUND_STRING("Poke Ball") },
    { FLAG_ITEM_PETALBURG_WOODS_ETHER, COMPOUND_STRING("Ether") },
    { FLAG_ITEM_MAGMA_HIDEOUT_3F_3R_ECAPE_ROPE, COMPOUND_STRING("Escape Rope") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_1_ORANGE_MAIL, COMPOUND_STRING("Orange Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_HARBOR_MAIL, COMPOUND_STRING("Harbor Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_WAVE_MAIL, COMPOUND_STRING("Wave Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_SHADOW_MAIL, COMPOUND_STRING("Shadow Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_WOOD_MAIL, COMPOUND_STRING("Wood Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_4_MECH_MAIL, COMPOUND_STRING("Mech Mail") },
    { FLAG_ITEM_ROUTE_124_YELLOW_SHARD, COMPOUND_STRING("Yellow Shard") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_6_GLITTER_MAIL, COMPOUND_STRING("Glitter Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_7_TROPIC_MAIL, COMPOUND_STRING("Tropic Mail") },
    { FLAG_ITEM_TRICK_HOUSE_PUZZLE_8_BEAD_MAIL, COMPOUND_STRING("Bead Mail") },
    { FLAG_ITEM_JAGGED_PASS_BURN_HEAL, COMPOUND_STRING("Burn Heal") },
    { FLAG_ITEM_AQUA_HIDEOUT_B1F_MAX_ELIXIR, COMPOUND_STRING("Max Elixir") },
    { FLAG_ITEM_AQUA_HIDEOUT_B2F_NEST_BALL, COMPOUND_STRING("Nest Ball") },
    { FLAG_ITEM_MT_PYRE_EXTERIOR_MAX_POTION, COMPOUND_STRING("Max Potion") },
    { FLAG_ITEM_MT_PYRE_EXTERIOR_TM_SKILL_SWAP, COMPOUND_STRING("TM Skill Swap") },
    { FLAG_ITEM_NEW_MAUVILLE_ULTRA_BALL, COMPOUND_STRING("Ultra Ball") },
    { FLAG_ITEM_NEW_MAUVILLE_ESCAPE_ROPE, COMPOUND_STRING("Escape Rope") },
    { FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_6_LUXURY_BALL, COMPOUND_STRING("Luxury Ball") },
    { FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_2_SCANNER, COMPOUND_STRING("Scanner") },
    { FLAG_ITEM_SCORCHED_SLAB_TM_SUNNY_DAY, COMPOUND_STRING("TM Sunny Day") },
    { FLAG_ITEM_METEOR_FALLS_B1F_2R_TM_DRAGON_CLAW, COMPOUND_STRING("TM Dragon Claw") },
    { FLAG_ITEM_SHOAL_CAVE_ENTRANCE_BIG_PEARL, COMPOUND_STRING("Big Pearl") },
    { FLAG_ITEM_SHOAL_CAVE_INNER_ROOM_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_SHOAL_CAVE_STAIRS_ROOM_ICE_HEAL, COMPOUND_STRING("Ice Heal") },
    { FLAG_ITEM_VICTORY_ROAD_1F_MAX_ELIXIR, COMPOUND_STRING("Max Elixir") },
    { FLAG_ITEM_VICTORY_ROAD_1F_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_VICTORY_ROAD_B1F_TM_PSYCHIC, COMPOUND_STRING("TM Psychic") },
    { FLAG_ITEM_VICTORY_ROAD_B1F_FULL_RESTORE, COMPOUND_STRING("Full Restore") },
    { FLAG_ITEM_VICTORY_ROAD_B2F_FULL_HEAL, COMPOUND_STRING("Full Heal") },
    { FLAG_ITEM_MT_PYRE_6F_TM_SHADOW_BALL, COMPOUND_STRING("TM Shadow Ball") },
    { FLAG_ITEM_SEAFLOOR_CAVERN_ROOM_9_TM_EARTHQUAKE, COMPOUND_STRING("TM Earthquake") },
    { FLAG_ITEM_FIERY_PATH_TM_TOXIC, COMPOUND_STRING("TM Toxic") },
    { FLAG_ITEM_ROUTE_124_RED_SHARD, COMPOUND_STRING("Red Shard") },
    { FLAG_ITEM_ROUTE_124_BLUE_SHARD, COMPOUND_STRING("Blue Shard") },
    { FLAG_ITEM_SAFARI_ZONE_NORTH_WEST_TM_SOLAR_BEAM, COMPOUND_STRING("TM Solar Beam") },
    ...
    { FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_1_TM_RAIN_DANCE, COMPOUND_STRING("TM Rain Dance") },
    { FLAG_ITEM_ROUTE_121_CARBOS, COMPOUND_STRING("Carbos") },
    { FLAG_ITEM_ROUTE_123_ULTRA_BALL, COMPOUND_STRING("Ultra Ball") },
    { FLAG_ITEM_ROUTE_126_GREEN_SHARD, COMPOUND_STRING("Green Shard") },
    { FLAG_ITEM_ROUTE_119_HYPER_POTION_2, COMPOUND_STRING("Hyper Potion") },
    { FLAG_ITEM_ROUTE_120_HYPER_POTION, COMPOUND_STRING("Hyper Potion") },
    { FLAG_ITEM_ROUTE_120_NEST_BALL, COMPOUND_STRING("Nest Ball") },
    { FLAG_ITEM_ROUTE_123_ELIXIR, COMPOUND_STRING("Elixir") },
    { FLAG_ITEM_NEW_MAUVILLE_THUNDER_STONE, COMPOUND_STRING("Thunder Stone") },
    { FLAG_ITEM_FIERY_PATH_FIRE_STONE, COMPOUND_STRING("Fire Stone") },
    { FLAG_ITEM_SHOAL_CAVE_ICE_ROOM_TM_HAIL, COMPOUND_STRING("TM Hail") },
    { FLAG_ITEM_SHOAL_CAVE_ICE_ROOM_NEVER_MELT_ICE, COMPOUND_STRING("Never Melt Ice") },
    { FLAG_ITEM_ROUTE_103_GUARD_SPEC, COMPOUND_STRING("Guard Spec") },
    { FLAG_ITEM_ROUTE_104_QUIET_MINT, COMPOUND_STRING("Quiet Mint") },
    { FLAG_ITEM_MAUVILLE_CITY_X_SPEED, COMPOUND_STRING("X Speed") },
    { FLAG_ITEM_PETALBURG_WOODS_PARALYZE_HEAL, COMPOUND_STRING("Paralyze Heal") },
    { FLAG_ITEM_ROUTE_115_GREAT_BALL, COMPOUND_STRING("Great Ball") },
    { FLAG_ITEM_SAFARI_ZONE_NORTH_CALCIUM, COMPOUND_STRING("Calcium") },
    { FLAG_ITEM_MT_PYRE_3F_SUPER_REPEL, COMPOUND_STRING("Super Repel") },
    { FLAG_ITEM_ROUTE_118_HYPER_POTION, COMPOUND_STRING("Hyper Potion") },
    { FLAG_ITEM_NEW_MAUVILLE_FULL_HEAL, COMPOUND_STRING("Full Heal") },
    { FLAG_ITEM_NEW_MAUVILLE_PARALYZE_HEAL, COMPOUND_STRING("Paralyze Heal") },
    { FLAG_ITEM_AQUA_HIDEOUT_B1F_MASTER_BALL, COMPOUND_STRING("Master Ball") },
    { FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MASTER_BALL, COMPOUND_STRING("Master Ball") },
    { FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MAX_ELIXIR, COMPOUND_STRING("Max Elixir") },
    { FLAG_ITEM_OLD_MAGMA_HIDEOUT_B2F_NEST_BALL, COMPOUND_STRING("Nest Ball") },
    { FLAG_ITEM_FIERY_PATH_FLAME_ORB, COMPOUND_STRING("Flame Orb") },
    { FLAG_ITEM_MT_PYRE_2F_ULTRA_BALL, COMPOUND_STRING("Ultra Ball") },
    { FLAG_ITEM_MT_PYRE_4F_SEA_INCENSE, COMPOUND_STRING("Sea Incense") },
    { FLAG_ITEM_SAFARI_ZONE_SOUTH_WEST_MAX_REVIVE, COMPOUND_STRING("Max Revive") },
    { FLAG_ITEM_AQUA_HIDEOUT_B1F_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_MOSSDEEP_STEVENS_HOUSE_HM08, COMPOUND_STRING("HM08") },
    { FLAG_ITEM_ROUTE_119_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_ROUTE_104_POTION, COMPOUND_STRING("Potion") },
    { FLAG_ITEM_FIERY_PATH_BURN_HEAL, COMPOUND_STRING("Burn Heal") },
    { FLAG_ITEM_ROUTE_103_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_RUSTURF_TUNNEL_AIR_BALLOON, COMPOUND_STRING("Air Balloon") },
    { FLAG_ITEM_ROUTE_108_STAR_PIECE, COMPOUND_STRING("Star Piece") },
    { FLAG_ITEM_ROUTE_109_POTION, COMPOUND_STRING("Potion") },
    { FLAG_ITEM_ROUTE_110_ELIXIR, COMPOUND_STRING("Elixir") },
    { FLAG_ITEM_ROUTE_111_ELIXIR, COMPOUND_STRING("Elixir") },
    { FLAG_ITEM_ROUTE_113_HYPER_POTION, COMPOUND_STRING("Hyper Potion") },
    { FLAG_ITEM_ROUTE_115_HEAL_POWDER, COMPOUND_STRING("Heal Powder") },
    { FLAG_ITEM_ROUTE_104_KINGS_ROCK, COMPOUND_STRING("Kings Rock") },
    { FLAG_ITEM_ROUTE_116_POTION, COMPOUND_STRING("Potion") },
    { FLAG_ITEM_ROUTE_119_ELIXIR_2, COMPOUND_STRING("Elixir") },
    { FLAG_ITEM_ROUTE_120_REVIVE, COMPOUND_STRING("Revive") },
    { FLAG_ITEM_ROUTE_121_REVIVE, COMPOUND_STRING("Revive") },
    { FLAG_ITEM_ROUTE_121_ZINC, COMPOUND_STRING("Zinc") },
    { FLAG_ITEM_MAGMA_HIDEOUT_1F_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_123_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_ROUTE_123_REVIVAL_HERB, COMPOUND_STRING("Revival Herb") },
    { FLAG_ITEM_ROUTE_125_BIG_PEARL, COMPOUND_STRING("Big Pearl") },
    { FLAG_ITEM_ROUTE_127_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_132_PROTEIN, COMPOUND_STRING("Protein") },
    { FLAG_ITEM_ROUTE_133_MAX_REVIVE, COMPOUND_STRING("Max Revive") },
    { FLAG_ITEM_ROUTE_134_CARBOS, COMPOUND_STRING("Carbos") },
    { FLAG_ITEM_ROUTE_134_STAR_PIECE, COMPOUND_STRING("Star Piece") },
    { FLAG_ITEM_ROUTE_114_ENERGY_POWDER, COMPOUND_STRING("Energy Powder") },
    { FLAG_ITEM_ROUTE_115_PP_UP, COMPOUND_STRING("Pp Up") },
    { FLAG_ITEM_ARTISAN_CAVE_B1F_HP_UP, COMPOUND_STRING("Hp Up") },
    { FLAG_ITEM_ARTISAN_CAVE_1F_CARBOS, COMPOUND_STRING("Carbos") },
    { FLAG_ITEM_MAGMA_HIDEOUT_2F_2R_MAX_ELIXIR, COMPOUND_STRING("Max Elixir") },
    { FLAG_ITEM_MAGMA_HIDEOUT_2F_2R_FULL_RESTORE, COMPOUND_STRING("Full Restore") },
    { FLAG_ITEM_MAGMA_HIDEOUT_3F_1R_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_MAGMA_HIDEOUT_3F_2R_PP_MAX, COMPOUND_STRING("Pp Max") },
    { FLAG_ITEM_MAGMA_HIDEOUT_4F_MAX_REVIVE, COMPOUND_STRING("Max Revive") },
    { FLAG_ITEM_SAFARI_ZONE_NORTH_EAST_NUGGET, COMPOUND_STRING("Nugget") },
    { FLAG_ITEM_SAFARI_ZONE_SOUTH_EAST_BIG_PEARL, COMPOUND_STRING("Big Pearl") },
    { FLAG_ITEM_MT_CHIMNEY_TM_FIRE_PUNCH, COMPOUND_STRING("TM Fire Punch") },
    { FLAG_ITEM_PETALBURG_CAVE_GREAT_BALL, COMPOUND_STRING("Great Ball") },
    { FLAG_ITEM_LITTLEROOTCOAST2_DIVE_BALL, COMPOUND_STRING("Dive Ball") },
    { FLAG_ITEM_LITTLEROOTCOAST2_PEARL, COMPOUND_STRING("Pearl") },
    { FLAG_ITEM_AQUASHIP_ROOM_DAMP_ROCK, COMPOUND_STRING("Damp Rock") },
    { FLAG_ITEM_PETALBURG_CAVE2_DIVE_BALL, COMPOUND_STRING("Dive Ball") },
    { FLAG_ITEM_PETALBURG_CAVE2_KINGS_ROCK, COMPOUND_STRING("Kings Rock") },
    { FLAG_ITEM_PETALBURG_CAVE2_RARE_CANDY, COMPOUND_STRING("Rare Candy") },
    { FLAG_ITEM_ROUTE_105_PEARL, COMPOUND_STRING("Pearl") },
    { FLAG_ITEM_ROUTE_118_HEART_SCALE, COMPOUND_STRING("Heart Scale") },
    { FLAG_ITEM_FORTREE_CITY_TIMID_MINT, COMPOUND_STRING("Timid Mint") },
    { FLAG_ITEM_ROUTE_117_CARBOS, COMPOUND_STRING("Carbos") },
    { FLAG_ITEM_ROUTE_115_PROTEIN, COMPOUND_STRING("Protein") },
    { FLAG_ITEM_ROUTE_110_MAX_REVIVE, COMPOUND_STRING("Max Revive") },
    { FLAG_ITEM_ROUTE_114_RAZOR_FANG, COMPOUND_STRING("Razor Fang") },
    { FLAG_ITEM_FOSSIL_TRENCH_DEEP_SEA_TOOTH, COMPOUND_STRING("Deep Sea Tooth") },
    { FLAG_ITEM_FOSSIL_TRENCH_DEEP_SEA_SCALE, COMPOUND_STRING("Deep Sea Scale") },
    { FLAG_ITEM_RUSTBORO_CITY_TM_FOUL_PLAY, COMPOUND_STRING("TM Foul Play") },
    { FLAG_ITEM_ROUTENEW101_POKE_BALL, COMPOUND_STRING("Poke Ball") },
};

static const u8 sDebugText_DeleteAllConfirm[] = _("Are you sure you want to\ndelete all?");
...
{
    [DEBUG_FNPC_ZENNO]  = { gFollowerNPCStringsTable[DEBUG_FNPC_ZENNO],  DebugAction_CreateFollowerNPC },
...
static const struct DebugMenuOption sDebugMenu_Actions_Party[] =
{
    ...
    { COMPOUND_STRING("Max Friendship"),     DebugAction_Party_MaxFriendship },
...
static const struct WindowTemplate sDebugMenuWindowTemplateConfirm =
{
    .bg = 0,
    .tilemapLeft = 1,
    .tilemapTop = 6,
    ...
    .height = 6,
    .paletteNum = 15,
    // Main list occupies tiles through ~0x132; keep this temporary prompt separate.
    .baseBlock = 0x140,
};
...
static const struct WindowTemplate sDebugMenuWindowTemplateEncounterInfo =
{
    .bg = 0,
    .tilemapLeft = 1,
    .tilemapTop = 1,
    ...
    // Encounter Info owns the screen while open, so it can safely use
    // a large contiguous BG0 tile region.
    .baseBlock = 1,
};
...
#define tInfoItemsMaxOffset data[6]
#define DEBUG_INFO_ITEMS_ROWS 10

static const u8 *Debug_GetVisibleItemName(u16 flagId)
{
    u32 i;

    for (i = 0; i < ARRAY_COUNT(sDebugVisibleItemFlagNames); i++)
    {
        if (sDebugVisibleItemFlagNames[i].flagId == flagId)
            return sDebugVisibleItemFlagNames[i].name;
    }
...
static u16 Debug_CountMapItems(void)
{
    ...
    // Hidden pickups: the item ID and collection flag live directly in BgEvent.
    ...
    // Visible item balls: identify them through their FLAG_ITEM_* flag.
    for (i = 0; i < events->objectEventCount; i++)
    {
        if (Debug_GetVisibleItemName(events->objectEvents[i].flagId) != NULL)
            count++;
    }
...
static u8 Debug_DrawInfoItemsPage(u8 windowId, u8 offset)
{
    ...
    if (total > DEBUG_INFO_ITEMS_ROWS)
        maxOffset = total - DEBUG_INFO_ITEMS_ROWS;

    if (offset > maxOffset)
        offset = maxOffset;

    // Hidden items first. Their runtime map data gives us the exact item name,
    // flag state without touching the save.
    for (i = 0; i < events->bgEventCount && drawn < DEBUG_INFO_ITEMS_ROWS; i++)
    {
    ...
    // Visible item balls. The object's collection flag is preserved in the
    // map template even after the sprite disappears, so COLLECTED still works.
    for (i = 0; i < events->objectEventCount && drawn < DEBUG_INFO_ITEMS_ROWS; i++)
    {
        const struct ObjectEventTemplate *obj = &events->objectEvents[i];
        const u8 *itemName = Debug_GetVisibleItemName(obj->flagId);
...
static void DebugAction_Util_InfoItems(u8 taskId)
{
    ...
    windowId = AddWindow(&sDebugMenuWindowTemplateEncounterInfo);
    DrawStdWindowFrame(windowId, FALSE);
    FillWindowPixelBuffer(windowId, PIXEL_FILL(1));
    ...
    gTasks[infoTaskId].tInfoItemsOffset = 0;
    gTasks[infoTaskId].tInfoItemsMaxOffset = maxOffset;
}

static void DebugTask_HandleInfoItems(u8 taskId)
{
    u8 windowId = gTasks[taskId].tInfoItemsWindowId;

    if (JOY_NEW(DPAD_UP))
    {
        if (gTasks[taskId].tInfoItemsOffset > 0)
        {
            PlaySE(SE_SELECT);
            gTasks[taskId].tInfoItemsOffset--;
            gTasks[taskId].tInfoItemsMaxOffset =
                Debug_DrawInfoItemsPage(windowId, gTasks[taskId].tInfoItemsOffset);
        }
        return;
    }
    ...
    if (JOY_NEW(DPAD_DOWN))
    {
        if (gTasks[taskId].tInfoItemsOffset < gTasks[taskId].tInfoItemsMaxOffset)
        {
            PlaySE(SE_SELECT);
            gTasks[taskId].tInfoItemsOffset++;
            gTasks[taskId].tInfoItemsMaxOffset =
...
#undef tInfoItemsWindowId
#undef tInfoItemsOffset
#undef tInfoItemsMaxOffset
#undef DEBUG_INFO_ITEMS_ROWS

#define tEncounterWindowId  data[1]
#define tEncounterPage      data[5]
#define tEncounterOffset    data[6]
#define tEncounterMaxOffset data[7]
#define DEBUG_ENCOUNTER_PAGE_COUNT 6
#define DEBUG_ENCOUNTER_ROWS_PER_SCREEN 10

// These are the slot weights used by pokeemerald-expansion's wild encounter
// schema. Duplicate species on a table are merged and their weights are added.
static const u8 sDebugEncounterRatesLand[LAND_WILD_COUNT] =
{
    20, 20, 10, 10, 10, 10, 5, 5, 4, 4, 1, 1
};

static const u8 sDebugEncounterRatesWater[WATER_WILD_COUNT] =
{
    60, 30, 5, 4, 1
};

static const u8 sDebugEncounterRatesRocks[ROCK_WILD_COUNT] =
{
    60, 30, 5, 4, 1
};

static const u8 sDebugEncounterRatesOldRod[] =
{
    70, 30
};

static const u8 sDebugEncounterRatesGoodRod[] =
{
    60, 20, 20
};

static const u8 sDebugEncounterRatesSuperRod[] =
{
    40, 40, 15, 4, 1
};
...
static void DebugAction_Util_EncounterInfo(u8 taskId)
{
    ...
    // Remove only the Utilities list. The submenu callback remains saved so B
    // can return directly to Utilities without adding another callback level.
    Debug_DestroyMenu(taskId);
    ...
    gTasks[infoTaskId].tEncounterPage = 0;
    gTasks[infoTaskId].tEncounterOffset = 0;
    gTasks[infoTaskId].tEncounterMaxOffset = maxOffset;
}
...
static u8 Debug_DrawEncounterInfoPage(u8 windowId, u8 page, u8 offset)
{
    ...
    const u8 *slotRates = NULL;
    enum WildPokemonArea area;
    enum TimeOfDay timeOfDay;
    const u8 *title;
    u16 speciesList[LAND_WILD_COUNT] = {0};
    u8 minLevels[LAND_WILD_COUNT] = {0};
    u8 maxLevels[LAND_WILD_COUNT] = {0};
    u8 totalRates[LAND_WILD_COUNT] = {0};
    u32 firstSlot = 0;
    u32 slotCount = 0;
    u32 uniqueCount = 0;
    u32 i;
    ...
    case 0:
        area = WILD_AREA_LAND;
        title = sDebugText_EncounterLand;
        slotRates = sDebugEncounterRatesLand;
        slotCount = LAND_WILD_COUNT;
        break;
    case 1:
        area = WILD_AREA_WATER;
        title = sDebugText_EncounterWater;
        slotRates = sDebugEncounterRatesWater;
        slotCount = WATER_WILD_COUNT;
        break;
    case 2:
        area = WILD_AREA_ROCKS;
        title = sDebugText_EncounterRocks;
        slotRates = sDebugEncounterRatesRocks;
        slotCount = ROCK_WILD_COUNT;
        break;
    case 3:
        area = WILD_AREA_FISHING;
        title = sDebugText_EncounterOldRod;
        slotRates = sDebugEncounterRatesOldRod;
        firstSlot = 0;
        slotCount = ARRAY_COUNT(sDebugEncounterRatesOldRod);
        break;
    case 4:
        area = WILD_AREA_FISHING;
        title = sDebugText_EncounterGoodRod;
        slotRates = sDebugEncounterRatesGoodRod;
        firstSlot = 2;
        slotCount = ARRAY_COUNT(sDebugEncounterRatesGoodRod);
        break;
    case 5:
        area = WILD_AREA_FISHING;
        title = sDebugText_EncounterSuperRod;
        slotRates = sDebugEncounterRatesSuperRod;
        firstSlot = 5;
        slotCount = ARRAY_COUNT(sDebugEncounterRatesSuperRod);
        break;
    }
    ...
    case WILD_AREA_FISHING:
        info = gWildMonHeaders[headerId].encounterTypes[timeOfDay].fishingMonsInfo;
        break;
    default:
        break;
    }
    ...
    // Merge repeated species. Example: if Aggron appears in two 10% slots,
    // display it once at 20%. Its displayed level range spans all its slots.
    for (i = 0; i < slotCount; i++)
    {
        const struct WildPokemon *wildMon = &info->wildPokemon[firstSlot + i];
        u16 species = wildMon->species;
        u32 j;
        ...
        {
            if (speciesList[j] == species)
                break;
        }

        if (j == uniqueCount)
        {
            speciesList[j] = species;
            minLevels[j] = wildMon->minLevel;
            maxLevels[j] = wildMon->maxLevel;
            totalRates[j] = 0;
            uniqueCount++;
        }
        else
        {
            if (wildMon->minLevel < minLevels[j])
                minLevels[j] = wildMon->minLevel;
            if (wildMon->maxLevel > maxLevels[j])
                maxLevels[j] = wildMon->maxLevel;
        }

        totalRates[j] += slotRates[i];
    }

    // Never squeeze the font. Dense tables scroll vertically instead.
    if (uniqueCount > DEBUG_ENCOUNTER_ROWS_PER_SCREEN)
        maxOffset = uniqueCount - DEBUG_ENCOUNTER_ROWS_PER_SCREEN;

    if (offset > maxOffset)
        offset = maxOffset;

    endIndex = offset + DEBUG_ENCOUNTER_ROWS_PER_SCREEN;
    if (endIndex > uniqueCount)
        endIndex = uniqueCount;
    ...
    for (i = offset; i < endIndex; i++)
    {
        ...
        if (maxLevels[i] != minLevels[i])
        {
            ...
            ConvertIntToDecimalStringN(gStringVar1, maxLevels[i], STR_CONV_MODE_LEFT_ALIGN, 3);
            StringAppend(gStringVar4, gStringVar1);
        }

        StringAppend(gStringVar4, COMPOUND_STRING("  "));
        ConvertIntToDecimalStringN(gStringVar1, totalRates[i], STR_CONV_MODE_LEFT_ALIGN, 3);
        StringAppend(gStringVar4, gStringVar1);
        StringAppend(gStringVar4, COMPOUND_STRING("%"));
...
static void DebugTask_HandleEncounterInfo(u8 taskId)
{
    u8 windowId = gTasks[taskId].tEncounterWindowId;

    if (JOY_NEW(DPAD_LEFT | L_BUTTON))
    {
        PlaySE(SE_SELECT);

        if (gTasks[taskId].tEncounterPage == 0)
            gTasks[taskId].tEncounterPage = DEBUG_ENCOUNTER_PAGE_COUNT - 1;
        else
            gTasks[taskId].tEncounterPage--;

        gTasks[taskId].tEncounterOffset = 0;
        gTasks[taskId].tEncounterMaxOffset =
            Debug_DrawEncounterInfoPage(windowId, gTasks[taskId].tEncounterPage, 0);
        return;
    }
    ...
    if (JOY_NEW(DPAD_RIGHT | R_BUTTON))
    {
        ...
        gTasks[taskId].tEncounterPage++;
        if (gTasks[taskId].tEncounterPage >= DEBUG_ENCOUNTER_PAGE_COUNT)
            gTasks[taskId].tEncounterPage = 0;
    ...
    if (JOY_NEW(DPAD_UP))
    {
        if (gTasks[taskId].tEncounterOffset > 0)
        {
            PlaySE(SE_SELECT);
            gTasks[taskId].tEncounterOffset--;
            gTasks[taskId].tEncounterMaxOffset =
                Debug_DrawEncounterInfoPage(
                    windowId,
                    gTasks[taskId].tEncounterPage,
                    gTasks[taskId].tEncounterOffset
                );
    ...
    if (JOY_NEW(DPAD_DOWN))
    {
        if (gTasks[taskId].tEncounterOffset < gTasks[taskId].tEncounterMaxOffset)
        {
            PlaySE(SE_SELECT);
            gTasks[taskId].tEncounterOffset++;
            gTasks[taskId].tEncounterMaxOffset =
...
#undef tEncounterWindowId
#undef tEncounterPage
#undef tEncounterOffset
#undef tEncounterMaxOffset
#undef DEBUG_ENCOUNTER_PAGE_COUNT
#undef DEBUG_ENCOUNTER_ROWS_PER_SCREEN

static void DebugAction_Util_LastHealPoint(u8 taskId)
{
    PlaySE(SE_SELECT);

    // This uses the game's own recorded last-heal warp instead of arbitrary
    // map coordinates, making it much safer than the removed debug warp tool.
...
static void Debug_DrawSetMonLevelCap(u8 windowId, s8 slot)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_SMALL, sDebugText_SetMonCapTitle, 8, 4, 0, NULL);

    if (slot < 0)
    {
        AddTextPrinterParameterized(windowId, FONT_SMALL, sDebugText_SetMonCapNoMon, 8, 18, 0, NULL);
        AddTextPrinterParameterized(windowId, FONT_SMALL, sDebugText_SetMonCapControls, 8, 34, 0, NULL);
        CopyWindowToVram(windowId, COPYWIN_GFX);
        return;
    }

    {
        ...
        AddTextPrinterParameterized(windowId, FONT_SMALL, gStringVar4, 8, 18, 0, NULL);
    }
...
{
    u8 windowId = AddWindow(&sDebugMenuWindowTemplateConfirm);
    s8 slot = Debug_FindNextUsablePartyMon(-1, 1);

    PlaySE(SE_SELECT);

    DrawStdWindowFrame(windowId, FALSE);
    gTasks[taskId].tSubWindowId = windowId;
    gTasks[taskId].tInput = slot;
    gTasks[taskId].func = DebugTask_HandleSetMonLevelCap;

    Debug_DrawSetMonLevelCap(windowId, slot);
    PutWindowTilemap(windowId);
    CopyWindowToVram(windowId, COPYWIN_FULL);
}
...
{
    u8 windowId = gTasks[taskId].tSubWindowId;
    s8 slot = gTasks[taskId].tInput;

    if (JOY_NEW(DPAD_LEFT | L_BUTTON))
    {
        PlaySE(SE_SELECT);
        slot = Debug_FindNextUsablePartyMon(slot, -1);
        gTasks[taskId].tInput = slot;
        Debug_DrawSetMonLevelCap(windowId, slot);
        return;
    }
    ...
    // Reveal the Utilities list again.
    DrawStdWindowFrame(gTasks[taskId].tWindowId, FALSE);
    PutWindowTilemap(gTasks[taskId].tWindowId);
    RedrawListMenu(gTasks[taskId].tMenuTaskId);
    CopyWindowToVram(gTasks[taskId].tWindowId, COPYWIN_FULL);
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gTasks[taskId].tIsComplex == FALSE)
        {
            ...
            // new party member is created.
            {
                ...
                // Keep the existing triangle marking used to identify
                // menu-generated Pokémon.
...
static void DebugAction_PCBag_Fill_PocketItems(u8 taskId)
{
    ...
    for (itemId = 1; itemId < ITEMS_COUNT; itemId++)
    {
        if ((GetItemPocket(itemId) == POCKET_ITEMS || GetItemPocket(itemId) == POCKET_MEDICINE)
...
static void DebugAction_PCBag_ClearBag(u8 taskId)
{
    DebugAction_ShowDestructiveConfirmation(taskId, 0);
}

static void DebugAction_PCBag_ClearBoxes(u8 taskId)
{
    DebugAction_ShowDestructiveConfirmation(taskId, 1);
}

#define tClearTarget data[5]
#define tClearChoice data[6]

static void DebugAction_ShowDestructiveConfirmation(u8 taskId, u8 target)
{
    u8 windowId;

    windowId = AddWindow(&sDebugMenuWindowTemplateConfirm);
    DrawStdWindowFrame(windowId, FALSE);
    FillWindowPixelBuffer(windowId, PIXEL_FILL(1));
    ...
    AddTextPrinterParameterized(
        ...
        FONT_SMALL,
        target == 2
            ? sDebugText_CompletePokedexConfirm
            : sDebugText_DeleteAllConfirm,
        8,
        6,
        0,
        NULL
    ...
    // Always start on NO for destructive actions.
    AddTextPrinterParameterized(
        windowId,
        FONT_NORMAL,
        sDebugText_DeleteAllNo,
    ...
    gTasks[taskId].tSubWindowId = windowId;
    gTasks[taskId].tClearTarget = target; // 0 = Bag, 1 = Storage Boxes, 2 = Complete Pokédex
    gTasks[taskId].tClearChoice = 1;      // 0 = YES, 1 = NO
    gTasks[taskId].func = DebugTask_HandleDestructiveConfirmation;
}
...
static void DebugTask_HandleDestructiveConfirmation(u8 taskId)
{
    ...
    {
        PlaySE(SE_SELECT);
        gTasks[taskId].tClearChoice ^= 1;

        FillWindowPixelRect(windowId, PIXEL_FILL(1), 120, 30, 96, 16);
        AddTextPrinterParameterized(
            windowId,
            FONT_NORMAL,
            gTasks[taskId].tClearChoice == 0
                ? sDebugText_DeleteAllYes
                : sDebugText_DeleteAllNo,
            128,
            34,
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gTasks[taskId].tClearChoice == 0)
        {
            if (gTasks[taskId].tClearTarget == 0)
            {
                ClearBag();
            }
            else if (gTasks[taskId].tClearTarget == 1)
            {
    ...
    // Confirmed Complete Pokédex behaves like the old instant action.
    if (gTasks[taskId].tClearTarget == 2
     && gTasks[taskId].tClearChoice == 0)
    {
        Debug_DestroyMenu_Full(taskId);
        ScriptContext_Enable();
    ...
    // NO/B returns safely to the submenu that opened the prompt.
    DrawStdWindowFrame(gTasks[taskId].tWindowId, FALSE);
    PutWindowTilemap(gTasks[taskId].tWindowId);
    RedrawListMenu(gTasks[taskId].tMenuTaskId);
    CopyWindowToVram(gTasks[taskId].tWindowId, COPYWIN_FULL);
...
static const u32 gDebugFollowerNPCGraphics[DEBUG_FNPC_COUNT] =
{
    [DEBUG_FNPC_ZENNO]  = OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL,
...
static void DebugAction_Party_HealParty(u8 taskId)
{
    ...
    // HealPlayerParty -> HealPokemon: full HP, status and move PP restore.
    HealPlayerParty();
...
static void DebugAction_Party_MaxFriendship(u8 taskId)
{
    ...
    for (i = 0; i < PARTY_SIZE; i++)
    {
        ...
        // Do not touch Eggs: their friendship field participates in egg data.
