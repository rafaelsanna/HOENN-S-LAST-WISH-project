...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 12, BALL_FAST },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 8, BALL_NET },
    ...
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 10, BALL_LOVE },
    ...
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID"), 10, BALL_FRIEND },
    ...
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA"), 3, BALL_NET },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 5, BALL_FAST },
    ...
    [TRAINER_CLASS_CLIMBER] = { _("CLIMBER"), 10, BALL_HEAVY },
    [TRAINER_CLASS_ARTIST] = { _("ARTIST"), 10, BALL_DREAM },
    [TRAINER_CLASS_PUNK] = { _("PUNK"), 10, BALL_MOON },
    [TRAINER_CLASS_WORKER] = { _("WORKER"), 10, BALL_REPEAT },
    [TRAINER_CLASS_DIVER] = { _("DIVER"), 10, BALL_DIVE },
    [TRAINER_CLASS_CHEERLEADER] = { _("CHEERLEADER"), 10 },
    [TRAINER_CLASS_BAKER] = { _("BAKER"), 10 },
    [TRAINER_CLASS_PHOTOGRAPHER] = { _("PHOTOGRAPHER"), 10 },
    [TRAINER_CLASS_KIMONO_LADY] = { _("KIMONO LADY"), 10 },
    [TRAINER_CLASS_TEACHER] = { _("TEACHER"), 10 },
    ...
    [TRAINER_CLASS_CHEF] = { _("CHEF"), 10, BALL_HEAVY },
    [TRAINER_CLASS_GAMBLER] = { _("GAMBLER"), 10, BALL_REPEAT },
    [TRAINER_CLASS_ACCOUNTANT] = { _("ACCOUNTANT"), 20, BALL_LUXURY },
};
...
void CB2_InitBattle(void)
{
    ...
    gBattleStruct->lastMonMusicPlayed = FALSE; // Confirmar que a musica do ultimo pokemon não está tocando
...
u8 IsRunningFromBattleImpossible(u32 battler)
{
    ...
    if (FlagGet(B_FLAG_NO_RUNNING) || gBattleTypeFlags & BATTLE_TYPE_DARK_AURA)
    {
            ...
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                         ...
                         || (FlagGet(B_FLAG_NO_RUNNING) == TRUE && gBattleResources->bufferB[battler][1] == B_ACTION_RUN))
                {
                    ...
                    return;
                      ...
                      && gBattleResources->bufferB[battler][1] == B_ACTION_THROW_BALL)
                {
                    gSelectionBattleScripts[battler] = BattleScript_CantCaptureEntity;
                    gBattleCommunication[battler] = STATE_SELECTION_SCRIPT;
                    gBattleStruct->selectionScriptFinished[battler] = FALSE;
                    gBattleStruct->stateIdAfterSelScript[battler] = STATE_BEFORE_ACTION_CHOSEN;
                    return;
