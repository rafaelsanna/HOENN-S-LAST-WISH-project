...
static const u8 sText_DarkAuraLurches[] = _("The aura lurches toward you!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("PROF. ACACIA: Don't leave me like this!\p"), //no decapitalize until it is everywhere
    ...
    [STRINGID_PICKEDUPITEM]                         = COMPOUND_STRING("{B_BUFF1} found one {B_BUFF2}!\p"),
    [STRINGID_PICKEDUPITEMPLACEDINBAG]              = COMPOUND_STRING("The item was placed in the Bag."),
    [STRINGID_PICKEDUPITEMSPLACEDINBAG]             = COMPOUND_STRING("The items were placed in the Bag."),
    ...
    [STRINGID_CANTCAPTUREENTITY]                    = COMPOUND_STRING("You can't capture this entity."),
};
...
const u8 gText_BattleWallyName[] = _("LUKA");
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            if (gBattleTypeFlags & BATTLE_TYPE_DARK_AURA)
                stringPtr = sText_DarkAuraLurches;
