...
#define HIDDEN_GROTTO_RESET_INTERVAL_DAYS 5
...
enum HiddenGrottoItemPool
{
    ...
    HIDDEN_GROTTO_ITEM_POOL_MT_PYRE,
    HIDDEN_GROTTO_ITEM_POOL_ROUTE110,
};
...
static const struct HiddenGrotto sHiddenGrottoData[NUM_HIDDEN_GROTTOES] =
{
    ...
    },
    {
        ...
        22,
        LOCALID_ROUTE110GROTTO_POKEMON,
        HIDDEN_GROTTO_ITEM_POOL_ROUTE110,
        ITEM_NONE,
        {
            {SPECIES_IGGLYBUFF, 0},
...
static const struct WeightedHiddenGrottoItem sMtPyreGrottoVisibleItems[] =
{
    {ITEM_HYPER_POTION, 18},
    {ITEM_DUSK_BALL, 16},
    {ITEM_REVIVE, 14},
...
static const struct WeightedHiddenGrottoItem sMtPyreGrottoHiddenItems[] =
{
    {ITEM_RARE_BONE, 18},
    {ITEM_SPELL_TAG, 14},
    {ITEM_REVIVAL_HERB, 12},
    {ITEM_DUSK_STONE, 10},
    {ITEM_MAX_ETHER, 8},
    {ITEM_CLEANSE_TAG, 8},
    {ITEM_PP_UP, 6},
...
static const struct WeightedHiddenGrottoItem sRoute110GrottoVisibleItems[] =
{
    {ITEM_SUPER_POTION, 18},
    {ITEM_GREAT_BALL, 16},
    {ITEM_NEST_BALL, 14},
...
static const struct WeightedHiddenGrottoItem sRoute110GrottoHiddenItems[] =
{
    {ITEM_ORAN_BERRY, 22},
    {ITEM_SITRUS_BERRY, 16},
    {ITEM_PECHA_BERRY, 14},
    {ITEM_TINYMUSHROOM, 12},
    {ITEM_HONEY, 12},
    {ITEM_STARDUST, 10},
    {ITEM_HEART_SCALE, 8},
    {ITEM_MOON_STONE, 6},
...
static const struct WeightedHiddenGrottoItem *GetHiddenGrottoVisibleItemPool(const struct HiddenGrotto *grotto, u8 *count)
{
    ...
    if (grotto != NULL && grotto->itemPool == HIDDEN_GROTTO_ITEM_POOL_MT_PYRE)
    {
        *count = ARRAY_COUNT(sMtPyreGrottoVisibleItems);
        return sMtPyreGrottoVisibleItems;
    }
    if (grotto != NULL && grotto->itemPool == HIDDEN_GROTTO_ITEM_POOL_ROUTE110)
    {
        *count = ARRAY_COUNT(sRoute110GrottoVisibleItems);
        return sRoute110GrottoVisibleItems;
    }
...
static const struct WeightedHiddenGrottoItem *GetHiddenGrottoHiddenItemPool(const struct HiddenGrotto *grotto, u8 *count)
{
    ...
    if (grotto != NULL && grotto->itemPool == HIDDEN_GROTTO_ITEM_POOL_MT_PYRE)
    {
        *count = ARRAY_COUNT(sMtPyreGrottoHiddenItems);
        return sMtPyreGrottoHiddenItems;
    }
    if (grotto != NULL && grotto->itemPool == HIDDEN_GROTTO_ITEM_POOL_ROUTE110)
    {
        *count = ARRAY_COUNT(sRoute110GrottoHiddenItems);
        return sRoute110GrottoHiddenItems;
    }
