...
"powers waiting to awaken within.$"),    
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_MAGIC_GUARD, ABILITY_NO_GUARD },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_BIG_PECKS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Its elegant white feathers glow with soft\n"
            "pink hues, captivating all who see it.\n"
            "The psychic crystals on its head draw\n"
            "Trainers, eager to witness its power."),
        .pokemonScale = 331,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 8,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .weight = 395,
        .description = COMPOUND_STRING(
            "Revered as a sky guardian, its crystalline\n"
            "wings shimmer with psychic energy.\n"
            "It foresees intruders, repelling foes\n"
            "swiftly with its powerful mind."),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_NINETALES] =
    {
       ...
       .description = COMPOUND_STRING(
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_GLOW_RED : ANIM_GLOW_RED,
...
#if P_UPDATED_TYPES >= GEN_6
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_FLYING, TYPE_FAIRY}
#else
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_SERENE_GRACE, ABILITY_WIND_RIDER },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_FRIEND_GUARD },
    #endif
        .bodyColor = BODY_COLOR_PINK,
...
.description = COMPOUND_STRING(
    ...
    "moonlight that gleams through its form.$"),
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 8 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_LEVITATE, ABILITY_INNER_FOCUS, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
...
.description = COMPOUND_STRING(
    ...
    "but to lure prey into its toxic embrace.$"),
        ...
        .frontPicSize = MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 14 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LEVITATE, ABILITY_CURSED_BODY, ABILITY_RATTLED },
    #else
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
    "Meowth withdraw their ghostly claws into\n"
    "their paws to drift in eerie silence.\n"
    "This Pokémon lurks in the shadows,\n"
    "drawn to the faint glimmer of lost coins."),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 12 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 8),
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_AMULET_COIN, SPECIES_PERSIAN, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .categoryName = _("Void Cat"),
        .height = 10,
        .weight = 320,
        .description = COMPOUND_STRING(
    "A Persian moves with unnatural grace,\n"
    "its body flickering like a dying flame.\n"
    "It is said to appear before those\n"
    "who have taken what was not theirs."),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_DAMP, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
...
"releasing shocks at those who grab it.$"),
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_POLIWRATH}
                            #if P_GEN_2_CROSS_EVOS
...
.description = COMPOUND_STRING(
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_DAMP, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
...
.description = COMPOUND_STRING(
    ...
    [SPECIES_ABRA] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_SWING_CONVEX_FAST : ANIM_SWING_CONVEX_FAST,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_CIRCULAR_VIBRATE : ANIM_CIRCULAR_VIBRATE,
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_FIGURE_8 : ANIM_FIGURE_8,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 11 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 20),
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_TIP_MOVE_FORWARD : ANIM_TIP_MOVE_FORWARD,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 19 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 4),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 4),
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LOADED_DICE, SPECIES_ELECTRODE}),
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_FLASH_YELLOW : ANIM_SHAKE_FLASH_YELLOW_FAST,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_STRETCH : ANIM_GLOW_RED,
