...
"the hotter its flames grow scorching all.$"),
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_KEEN_EYE, ABILITY_ADAPTABILITY },
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_INSOMNIA, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_INTIMIDATE, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .weight = 5,
        .description = COMPOUND_STRING(
            "This Fairy Pokémon drifts and floats while\n"
            "collecting round objects. It becomes happy\n"
            "when adding to its collection of spheres,\n"
            "carefully carrying them with its small hands."),
        .pokemonScale = 562,
        .pokemonOffset = -7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "This Fairy-Ice Pokémon rolls and throws\n"
            "a snowball at other Pokémon. The snowball\n"
            "grows larger as it rolls through snowy\n"
            "fields, becoming a powerful icy weapon."),
        .pokemonScale = 387,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .weight = 30,
        .description = COMPOUND_STRING(
            "Jumpluff builds a massive snowball that\n"
            "it hurls with incredible force. This Pokémon\n"
            "can roll snowballs so large they become\n"
            "as big as boulders when fully grown."),
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
[SPECIES_URSALUNA] =
{
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_POISON_POINT, ABILITY_CORROSION, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_LIQUID_VOICE, ABILITY_QUEENLY_MAJESTY },
        .bodyColor = BODY_COLOR_WHITE,
...
.description = COMPOUND_STRING(
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_FLASH_FIRE, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_BLACK,
