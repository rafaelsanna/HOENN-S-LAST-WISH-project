...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_POISON_POINT, ABILITY_TOXIC_DEBRIS, ABILITY_UNBURDEN },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_SPEED_BOOST },
...
"distances, but cannot truly fly.$"),
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        .weight = 400,
        .description = COMPOUND_STRING(
             "Its ferret-like build lets it accelerate\n"
             "astonishing power, said to near sonic\n"
             "speeds. It roams vast such territories,\n"
             "clashing fiercely with packs of Howlyena."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_COMPOUND_EYES, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_COMPOUND_EYES, ABILITY_DRAGONS_MAW },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_COMPOUND_EYES, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_AFTERMATH, ABILITY_WHITE_SMOKE, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Forged in volcanic heat, it waits\n"
            "motionless for prey. When disturbed,\n"
            "it ignites its steel shell and charges,\n"
        ...
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
...
.evolutions = EVOLUTION(
    {EVO_LEVEL, 0, SPECIES_SHIFTRY, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_MIND_BLOWN, 1})},
    {EVO_LEVEL, 0, SPECIES_SHIFTRY, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_EXPLOSION, 1})}
),
    },
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_AFTERMATH, ABILITY_FLASH_FIRE, ABILITY_MEGA_LAUNCHER },
    #else
        ...
        .weight = 596,
        .description = COMPOUND_STRING(
            "Known as the Aftermath Pokémon. It is\n"
            "born from the bigest explosions.\n"
            "Its ballistic firepower transforms\n"
            "battlefields into instant wastelands."),
        .pokemonScale = 290,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
.description = COMPOUND_STRING(
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_BOUNCE_ROTATE_TO_SIDES : ANIM_BOUNCE_ROTATE_TO_SIDES,
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 16 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 6),
            ANIMCMD_FRAME(1, 6),
            ANIMCMD_FRAME(0, 6),
...
"with coordinated attacks from all sides."),
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHARPNESS, ABILITY_NORMALIZE, ABILITY_WONDER_SKIN },
    #else
...
.description = COMPOUND_STRING(
    ...
    "battles, gleams with deadly pride.\n"
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_SWARM, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_TINTED_LENS, ABILITY_PRANKSTER },
    #else
...
.description = COMPOUND_STRING(
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_THICK_FAT, ABILITY_OWN_TEMPO },
    #else
    ...
    "Its cute form hides immense resilience\n"
    "nothing in the sea can crush its spirit.$"),
        .pokemonScale = 342,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_HYPER_CUTTER, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_LEVITATE, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_ICE_BODY, ABILITY_SNOW_CLOAK, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .weight = 513,
        .description = COMPOUND_STRING(
            "Cacnea live in freezing regions where\n"
            "snow never melts. It battles by swinging\n"
            "its thick, icy arms. Its body remains\n"
            "solid even in extreme cold."),
        .pokemonScale = 455,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .categoryName = _("Snow Figure"),
        .height = 13,
        .weight = 774,
        .description = COMPOUND_STRING(
            "After enduring freezing climates for\n"
            "thousands of years, its body became\n"
            "hardened like packed snow. It is\n"
            "nocturnal, roaming in the cold nights."),
        .pokemonScale = 327,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_STRONG_JAW, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRESSURE, ABILITY_MAGIC_BOUNCE, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_STRONG_JAW, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_CURSED_BODY, ABILITY_CURSED_BODY, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_BATTLE_ARMOR, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
        ...
        .weight = 421,
        .description = COMPOUND_STRING(
            "This timid Pokémon hid deep inside caves\n"
            "after volcanic eruptions trapped it there.\n"
            "Rare metals melted around its body,\n"
            "forming nigh-unbreakable armor and horns."),
        .pokemonScale = 448,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_BATTLE_ARMOR, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .weight = 1105,
        .description = COMPOUND_STRING(
            "Nearly trapped inside its hardened armor,\n"
            "it must struggle greatly to evolve and\n"
            "break free. Its shell is said to be\n"
            "impossible to break by natural means."),
        .pokemonScale = 311,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_LEVITATE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .weight = 1026,
        .description = COMPOUND_STRING(
            "Having broken free of his shell once\n"
            "binding it, it now wears an unbreakable\n"
            "armor. Its blade-like wings rule the\n"
            "skies, and it fears absolutely nothing."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
