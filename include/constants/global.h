...
// Bag constants
#define BAG_LEGACY_ITEMS_COUNT 64
#define BAG_ITEMS_COUNT 152
#define BAG_MEDICINE_COUNT 56
#define BAG_ITEMS_EXTRA_COUNT (BAG_ITEMS_COUNT - BAG_LEGACY_ITEMS_COUNT)
#define BAG_KEYITEMS_COUNT 30
#define BAG_LEGACY_POKEBALLS_COUNT 16
#define BAG_POKEBALLS_COUNT 20
#define BAG_POKEBALLS_EXTRA_COUNT (BAG_POKEBALLS_COUNT - BAG_LEGACY_POKEBALLS_COUNT)
#define BAG_LEGACY_TMHM_COUNT 64
#define BAG_TMHM_COUNT 80
#define BAG_TMHM_EXTRA_COUNT (BAG_TMHM_COUNT - BAG_LEGACY_TMHM_COUNT)
...
#define OPTIONS_NPCTEAMS_CASUAL 0
#define OPTIONS_NPCTEAMS_HARD 1

#define OPTIONS_BATTLEITEMS_ON 0
#define OPTIONS_BATTLEITEMS_OFF 1

#define OPTIONS_INFINITECANDY_OFF 0
#define OPTIONS_INFINITECANDY_ON 1

#define OPTIONS_LEVELCAPS_ON 0
#define OPTIONS_LEVELCAPS_OFF 1

#define OPTIONS_EFFECTIVE_HELPER_FALSE 0
#define OPTIONS_EFFECTIVE_HELPER_TRUE 1

#define OPTIONS_COLOR_PALETTE_WHITE 0
#define OPTIONS_COLOR_PALETTE_BLACK 1
